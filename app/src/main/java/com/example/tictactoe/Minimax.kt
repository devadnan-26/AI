...
object Minimax {
    ...
    fun isGameWon(board: ArrayList<String>, player: String): Boolean =
        ...
        //check diagonals
        else if (board[0] == player && board[4] == player && board[8] == player) true
        else board[2] == player && board[4] == player && board[6] == player
    ...
    fun gameResult(board: ArrayList<String>): String {
        when {
            isGameWon(board, PLAYER_X) -> return "X"
            isGameWon(board, PLAYER_O) -> return "O"
